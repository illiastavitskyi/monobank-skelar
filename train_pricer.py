...
collection = chroma_client.get_collection(name="monobazar_items")
...
def build_features_and_train_xgb():
    ...
    joblib.dump(tfidf, BASE_DIR / "tfidf_vectorizer.pkl")
    ...
    model_fast.save_model(BASE_DIR / "xgb_fast.json")
    model_bal.save_model(BASE_DIR / "xgb_bal.json")
    model_max.save_model(BASE_DIR / "xgb_max.json")
